return {
    pet = {
        ...
        chin = {
            ...
            HAPPY = love.graphics.newImage('res/img/pet/chin_eat.png'),
            TONGUE_BODY = love.graphics.newImage('res/img/tongue_body.png'),
            TONGUE_TIP = love.graphics.newImage('res/img/tongue_tip.png'),
        },
        dasher = {
        ...
        dragon = {
            IDLE = love.graphics.newImage('res/img/pet/dragon.png'),
        },
        ferro = {
            IDLE = love.graphics.newImage('res/img/pet/ferro.png'),
        },
        lumpy = {
